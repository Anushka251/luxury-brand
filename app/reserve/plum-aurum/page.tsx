...
export default function PlumAurumReservationPage() {
  const {
    data: session,
  ...
  useEffect(() => {
    ...
    async function checkPrivateAccess() {
      try {
        ...
        console.error(
          "Plum Aurum private access check error:",
          error
        );
  ...
  useEffect(() => {
    ...
    async function refreshAccess() {
      try {
        ...
        console.error(
          "Plum Aurum private access refresh error:",
          error
        );
      }
    }
