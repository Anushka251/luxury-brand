      ...
      <section className="max-w-5xl mx-auto px-6 pt-10 pb-20">
        ...
        <div className="max-w-2xl mx-auto pt-12 text-center">
          ...
          <p className="mt-8 text-[15px] leading-8 text-[#6B625B]">
            ...
            Crimson Rose is individually finished in our atelier for
            collectors who value timeless craftsmanship over mass
            production. Each creation is priced at{" "}
            <strong>₹24,000</strong>. Studio reservations are available
